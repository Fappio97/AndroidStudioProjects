...
import static com.unito.prenotazioniandroid.Constants.PRENOTAZIONE_ARRAY_LIST_CLASS_TYPE;

public class ThePrenotazioniDBAPIClient {

    public static PrenotazioniAPIInterface getClient() {
        ...
        Gson gson = new GsonBuilder()
                ...
                .registerTypeAdapter(PRENOTAZIONE_ARRAY_LIST_CLASS_TYPE, new PrenotazioniJsonDeserializer())
                .create();
        ...
        return builder.build().create(PrenotazioniAPIInterface.class);
    }
}
